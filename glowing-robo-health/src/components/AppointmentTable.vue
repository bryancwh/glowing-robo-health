  ...
  methods: {
    async display() {
      ...
      z.forEach((docs) => {
        ...
        let date_text =
          String(visit_date.toDate().getDate()) +
          "/" +
          String(visit_date.toDate().getMonth() + 1) +
          "/" +
          String(visit_date.toDate().getFullYear());
        cell1.innerHTML = name;
        cell2.innerHTML = email;
        cell3.innerHTML = date_text;
        cell4.innerHTML = visit_time;
        cell5.innerHTML = doctor;
        cell6.innerHTML = conditions;
        cell9.innerHTML = doc_id;
